...
[no-cd]
bazel-remote-test:
    ./.github/scripts/run-bazel-ci.sh --print-failed-test-logs --use-node-test-env --use-ci-config -- test --test_tag_filters=-argument-comment-lint --test_verbose_timeout_warnings -- //... -//third_party/v8:all
