...
use crate::config_wizard::ConfigWizardApplyRequest;
use crate::config_wizard::ConfigWizardTextStep;
use crate::config_wizard::ConfigWizardWorkspaceWriteOption;
...
pub(crate) enum AppEvent {
    ...
    /// Re-open the access-mode step of the guided config wizard.
    OpenConfigWizardAccessMode,

    /// Re-open the workspace-write options step of the guided config wizard.
    OpenConfigWizardWorkspaceWriteOptions,

    /// Re-open a text-entry step of the guided config wizard.
    OpenConfigWizardTextStep {
        step: ConfigWizardTextStep,
    },

    /// Advance the config wizard with the selected access mode.
    ConfigWizardAccessModeSelected {
        access_mode: ConfigWizardAccessMode,
    },

    /// Advance the config wizard with the selected workspace-write options.
    ConfigWizardWorkspaceWriteOptionsSelected {
        selected: Vec<ConfigWizardWorkspaceWriteOption>,
    },

    /// Advance the config wizard with text input from the current prompt step.
    ConfigWizardTextSubmitted {
        step: ConfigWizardTextStep,
        value: String,
    },

    /// Write the config generated by the guided wizard.
    ApplyConfigWizard {
        request: ConfigWizardApplyRequest,
    },
