...
pub struct PermissionsToml {
    ...
    /// Applies when the `enable_network_proxy` feature or requirements start the proxy.
    pub network: Option<PermissionsNetworkToml>,
}

#[derive(Serialize, Deserialize, Debug, Clone, Default, PartialEq, Eq, JsonSchema)]
#[serde(deny_unknown_fields)]
#[schemars(deny_unknown_fields)]
pub struct PermissionsNetworkToml {
...
pub(crate) fn network_proxy_config_from_permissions(
    ...
    permissions
        ...
        .map_or_else(
            ...
            PermissionsNetworkToml::to_network_proxy_config,
        )
}
