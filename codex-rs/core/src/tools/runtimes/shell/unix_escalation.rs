...
fn resolve_host_zsh_path_from_path_env(
    path_env: Option<&str>,
...
fn resolve_host_zsh_path(path_env: Option<&str>, _cwd: &Path) -> Option<PathBuf> {
    ...
    resolve_host_zsh_path_from_path_env(path_env, &approved_host_zsh_paths).or_else(|| {
        find_zsh_in_dirs(
