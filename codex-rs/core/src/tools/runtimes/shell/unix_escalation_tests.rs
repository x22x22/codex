...
async fn prepare_escalated_exec_permissions_preserve_macos_seatbelt_extensions() {
    ...
    let permissions = Permissions {
        ...
        file_system_sandbox_policy: codex_protocol::protocol::FileSystemSandboxPolicy::from(
            &SandboxPolicy::new_read_only_policy(),
        ),
        network_sandbox_policy: codex_protocol::protocol::NetworkSandboxPolicy::Restricted,
        network: None,
