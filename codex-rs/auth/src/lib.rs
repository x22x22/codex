...
impl CodexAuth {
    ...
    pub fn from_auth_storage(
        ...
        Self::from_auth_storage_with_client_factory(
            codex_home,
    ...
    /// Loads auth information using a caller-provided HTTP client factory.
    pub fn from_auth_storage_with_client_factory(
        codex_home: &Path,
        auth_credentials_store_mode: AuthCredentialsStoreMode,
        client_factory: fn() -> CodexHttpClient,
    ) -> std::io::Result<Option<Self>> {
        load_auth_with_client_factory(
            codex_home,
            false,
            auth_credentials_store_mode,
            client_factory,
...
pub fn load_auth_with_client_factory(
    codex_home: &Path,
    enable_codex_api_key_env: bool,
    auth_credentials_store_mode: AuthCredentialsStoreMode,
    client_factory: fn() -> CodexHttpClient,
