...
pub enum ToolSuggestEntryType {
    Connector,
    Plugin,
}

impl ToolSuggestEntryType {
...
pub struct ToolSuggestEntry {
    ...
    pub name: String,
    pub description: Option<String>,
    pub tool_type: ToolSuggestEntryType,
    pub has_skills: bool,
...
fn tool_description_or_fallback(tool: &ToolSuggestEntry) -> String {
    ...
    match tool.tool_type {
        ToolSuggestEntryType::Connector => "No description provided.".to_string(),
        ToolSuggestEntryType::Plugin => plugin_summary(tool),
    }
}
